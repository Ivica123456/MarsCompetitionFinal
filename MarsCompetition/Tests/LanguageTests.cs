...
using System.Collections.Generic; // Make sure to include this namespace for List<T>
...
namespace MarsCompetition.Tests
{
    ...
    public class LanguageTests : CommonDriver
    {
        ...
        public void AddLanguagesTest()
        {
            ...
            string jsonContent = File.ReadAllText("C:\\Users\\Ivica\\Desktop\\MarsCompetitionTask\\MarsCompetition\\JSONData\\languages.json");
        ...
        public void AddLanguagesInvalidDataTest()
        {
            ...
            string jsonContent1 = File.ReadAllText("C:\\Users\\Ivica\\Desktop\\MarsCompetitionTask\\MarsCompetition\\JSONData\\negative_languages.json");
        ...
        public void EditLanguageTests()
        {
            ...
            // Read the JSON file
            string jsonFilePath = "C:\\Users\\Ivica\\Desktop\\MarsCompetitionTask\\MarsCompetition\\JSONData\\edit_languages.json";
